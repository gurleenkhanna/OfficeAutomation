...
$iD=$_SESSION['a'];
$sql = "SELECT Employee_id,First_name,Last_Name,Month,Present,Absent,Type_of_Leave,Leaves_Left FROM attendance where Employee_id=$iD";
$connection = connect();
...
echo"<tr><td align='center' colspan='9'>$row[Month]</td></tr>";
