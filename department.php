...
<li>
        ...
        <div id="page-wrapper" >
    		...
    		<div class="form-group">
               <input type="text" placeholder="Employee ID" name="EI">
            </div>
            <div class="form-group">
              <input type="text" placeholder="Department Id" name="DI">
            </div>
            <div class="form-group">
              <input type="text" placeholder="Department Name" name="DN">
            </div>
            <div class="form-group">
              <input type="text" placeholder="Department Manager" name="DM">
            </div>
                        <div class="form-group">
