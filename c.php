...
echo"<input type='number'  placeholder='Employee Id' name='ID'> <br/>";
echo"<input type='password'  placeholder='Old Password' name='P'><br/>";
echo"<input type='password'  placeholder='New Password' name='np'>";
